...
if __name__ == '__main__':
    ...
    tib_core_subjects = read_json_file('GND-Subjects-tib-core.json')
    ...
    for index, filename in enumerate(os.listdir(tibkat_resources_dir)):
        ...
        for record in data:
            ...
            main_dir = 'tibkat-dataset/all-subjects/data' if  to_include_in_final_dataset else 'tibkat-supplementary-dataset/all-subjects'
