...
if __name__ == '__main__':
    ...
    tib_core_subjects = read_json_file('../shared-task-GND/formatted-gnd-subjects/GND-Subjects-tib-core.json')
    ...
    for index, filename in enumerate(os.listdir(tibkat_resources_dir)):
        ...
        for record in data:
            ...
            main_dir = 'shared-task-dataset' if  to_include_in_final_dataset else 'shared-task-supplementary-dataset'
